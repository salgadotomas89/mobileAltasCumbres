...
export default function ReservarComputadorScreen() {
  ...
  const [customBaseUrl, setCustomBaseUrl] = useState(BASE_URL);
  ...
  // Configuración de las URLs de la API y modo simulación
  const configurarUrls = async () => {
    try {
      await AsyncStorage.setItem('apiUrl', customBaseUrl + RESERVAS_URL);
      await AsyncStorage.setItem('tokenUrl', customBaseUrl + AUTH_URL);
      await AsyncStorage.setItem('modoSimulacion', modoSimulacion ? 'true' : 'false');
  ...
  const renderConfigUrl = () => (
    <ThemedView style={styles.loginContainer}>
      <ThemedText style={styles.loginTitle}>Configuración</ThemedText>
      
      <ThemedText style={styles.label}>URL de Reservas:</ThemedText>
      <TextInput
        style={styles.input}
        placeholder="URL de API de Reservas"
        value={customBaseUrl + RESERVAS_URL}
        onChangeText={setCustomBaseUrl}
        autoCapitalize="none"
      />
      
      <ThemedText style={styles.label}>URL de Token:</ThemedText>
      <TextInput
        style={styles.input}
        placeholder="URL de Token"
        value={customBaseUrl + AUTH_URL}
        onChangeText={setCustomBaseUrl}
        autoCapitalize="none"
      />
      ...
      <TouchableOpacity 
        ...
        onPress={configurarUrls}
      >
        <ThemedText style={styles.textoBoton}>Guardar Configuración</ThemedText>
      </TouchableOpacity>
      ...
      >
        <ThemedText style={styles.textoBotonSecundario}>Cancelar</ThemedText>
      </TouchableOpacity>
    </ThemedView>
  );
  ...
  const renderLogin = () => (
    <ThemedView style={styles.loginContainer}>
      ...
      <TouchableOpacity 
        style={styles.botonConfigUrl} 
        onPress={() => setShowConfig(!showConfig)}
      >
        <ThemedText style={styles.textoBotonSecundario}>
          {showConfig ? 'Ocultar Configuración' : 'Mostrar Configuración'}
        </ThemedText>
      </TouchableOpacity>
      
      {showConfig && renderConfigUrl()}
    </ThemedView>
  );
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <ThemedText type="title" style={styles.title}>Reservas de Computador</ThemedText>
